...
OAUTH_SCOPE = 'https://www.googleapis.com/auth/fitness.activity.read'  # https://www.googleapis.com/auth/fitness.heart_rate.read
DATA_SOURCE = 'derived:com.google.calories.expended:com.google.android.gms:merge_calories_expended'  # derived:com.google.step_count.delta:com.google.android.gms:estimated_steps | | derived:com.google.heart_minutes:com.google.android.gms:merge_heart_minutes
...
def logwrite(date, step):
    with open('step.log', 'a') as outfile:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("Calorie:{}".format(sum(values)))
...
cleaning_file = open("step.log", "w")
cleaning_file.truncate()
cleaning_file.close()