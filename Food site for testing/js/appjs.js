...
function promocode() {
    ...
    if (code == "FREE ORDER") {
        ...
        document.getElementById("modal2body").innerHTML = "SORRY, BUT THE PROMOCODE YOU ENTERED IS NOT VALID.TRY ANOTHER ONE";
        document.getElementById("exampleModal2Label").innerHTML = "😔 🅵🅰🅸🅻🆄🆁🅴"
    }
}
...
function creditcardpayment() {
    document.getElementById("exampleModal2Label").innerHTML = "😔 🅵🅰🅸🅻🆄🆁🅴"
    document.getElementById("modal2body").innerHTML = "SORRY BUT THIS FEATURE IS STILL NOT AVAILABLE AT PRESENT";
}
